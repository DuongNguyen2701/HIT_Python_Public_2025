...
s1Dao = s1[::-1]
print("Đảo ngược chuỗi s1:", s1Dao)
...
if 1 <= a < b <= len(s2):
    ...
    s2Moi = s2[:a] + s2[a:b][::-1] + s2[b:]
    print("Chuỗi s2 sau khi đảo từ vị trí a đến b:", s2Moi)
else:
    print("Giá trị a và b không hợp lệ.")
    s2Moi = s2  # Giữ nguyên s2 nếu a, b không hợp lệ
